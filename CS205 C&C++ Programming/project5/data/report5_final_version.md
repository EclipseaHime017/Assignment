...
![](https://img.picui.cn/free/2024/06/02/665bf4c0430fd.png)
...
![](https://img.picui.cn/free/2024/06/02/665bf4c04438c.png)
...
![](https://img.picui.cn/free/2024/06/02/665bf4c0303de.png)
In contrast, running the same code on the server, the OpenBLAS time cost is reduced to around 110ms and cuBLAS is reduced to around 60ms.
...
1. To complete this project, we have to learn a lot rules embedded in CUDA toolkit and we need to understand meanings of each part during the calculation using kernel(For example, no kernel in the class).
...
3. Don't forget to link the cuBLAS and OpenBLAS library when compile the source code.
...
NVIDIA CUDA [CUDA 编程手册系列](https://developer.nvidia.com/zh-cn/blog/cuda-intro-cn/)

CSDN Blog [CUDA入门——cudaMalloc函数的理解](https://blog.csdn.net/CaiYuxingzzz/article/details/121112273)

CSDN Blog [在类内调用cuda内核函数，出现的错误： illegal combination of memory qualifiers 等问题的解决](https://blog.csdn.net/qq_35708970/article/details/126019299)

Linux-Console.net [如何在 Ubuntu 20.04 LTS 上安装 CUDA](https://cn.linux-console.net/?p=15127#google_vignette)